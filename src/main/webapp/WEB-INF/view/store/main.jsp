...
<!-- URL Resolve -->
<c:url var="URL_GET_LIST"					value="/store/"/>
<c:url var="URL_GET_ITEM_BASE" 				value="/store/"/>		<%-- /store/{id} --%>
<c:url var="URL_GET_PAGE_BASE" 				value="/store/page/"/>	<%-- /city/page/{pageNo} --%>

<c:url var="URL_POST_LIST_APPEND" 			value="/store/"/>
<c:url var="URL_POST_ITEM_APPEND" 			value="/store/"/>

<c:url var="URL_PUT_LIST_MODIFY" 			value="/store/"/>
